...
(function (onde) {
    ...
    var CardUI = (function (_super) {
        ...
        function CardUI(_user, _pass) {
            var _this = this;
            _super.call(this, "CardUI");
            this._user = _user;
            this._pass = _pass;
        ...
        CardUI.prototype.log = function (msg) {
            if (DEBUG) {
                console.log(msg);
            }
        };

        CardUI.prototype.connection = function () {
            return this._connection;
        };

        CardUI.prototype.history = function () {
            return this._history;
        };

        CardUI.prototype.initHistory = function () {
            var _this = this;
            this._history = new onde.History();
            this._history.register(function (state, child) {
                if (state != "card") {
                    _this._history.navigate(["card"]);
                    return;
                }
        ...
        CardUI.prototype.showCardDetail = function (cardId) {
            this.hideCardDetail();
            this._detail = new onde.CardDetail(this, cardId);
            this._container.appendChild(this._detail.elem());
        };

        CardUI.prototype.hideCardDetail = function () {
            if (this._detail) {
        ...
        CardUI.prototype.setStatus = function (msg) {
            this._statusElem.textContent = msg;
        };

        CardUI.prototype.onOpen = function () {
            this.log("connection open");
            this.setStatus("connected");
            this.connection().login(this._user, this._pass);
        };

        CardUI.prototype.onClose = function () {
        ...
        CardUI.prototype.onLogin = function () {
            this.initHistory();
